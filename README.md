...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/simber-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15023&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/simber-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `simber` can be installed with:

```
conda install simber
```

It is possible to list all of the versions of `simber` available on your platform with:
